...
class ProductAttributeNamesController extends Controller
{
...
//        print_r($categories);exit;
        ...
        return view('admin.products.attribute.names.index', compact('productAttributeNames', 'categories', 'currentCategory'));
    }
